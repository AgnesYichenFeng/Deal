...
//        let user = User(username: "XYZ", description: "Hi!")
//        return user
//    }
//
//    static func getComment() -> [Comment] {
//        let comments = [
//            Comment(userName: "Nina", message: "This is short"),
//            Comment(userName: "Yichen", message: "Hello testing a;lskjglsknlwrlmnblkwanrlgkn"),
//            Comment(userName: "Joyce", message: "2084ihnk;jnb;qjwrgskfjnvkjnownolbnljfnb,nfmnvblwknflbknlksfb"),
//            Comment(userName: "Xiangyi", message: "This is super long. hlaknsln92quh498yt9uhglwnlsfnvbonqlrknblknslfknvoiajleqknlkgnsfjvnoux hoknqelkn flknl jnoiajdflknb")
//        ]
//        return comments
//    }
//}
